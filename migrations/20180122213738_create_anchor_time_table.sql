...
CREATE TABLE `anchor_times` (
  ...
  `maize_area` double(11, 2) DEFAULT NULL COMMENT '玉米面积',
  `maize_subsidy` double(11, 2) DEFAULT NULL COMMENT '玉米补贴',
  `income` double(11, 2) DEFAULT NULL COMMENT '收入',
  `precipition` double(11, 2) DEFAULT NULL COMMENT '年度降雨',
  `eto` double(11, 2) DEFAULT NULL COMMENT '参考作物腾发量',
